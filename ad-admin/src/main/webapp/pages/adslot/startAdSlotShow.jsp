...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        $("#deleteSlot").on("click",deleteSolt);
        function deleteSolt(){
            ...
            $.post('<c:url value="/json/adSlot_deleteAdSlot.do"/>', {"id": codeStr.substring(0, codeStr.length-1)}, function (result) {
                bootbox.alert("操作成功！");
