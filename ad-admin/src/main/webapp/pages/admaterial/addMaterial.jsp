                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" id="createAdMaterialform">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="add_adMaterialName" placeholder="素材名称" class="col-xs-10 col-sm-5" name="adMaterial.materialName">
                            </div>
                        </div>
                        <div class="space-4"></div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="create_materialType"> 素材类型 </label>

                            <div class="col-sm-9">
                                <select class="col-xs-10 col-sm-5 chosen-select" id="create_materialType" data-placeholder="Choose a Country..." name="adMaterial.type">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea id="add_clickHref" class="col-xs-10 col-sm-5" style="width: 700px;height: 100px;"  name="adMaterial.clickHref"></textarea>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        $.get("<c:url value='/json/adad_getAdSlot.do'/>",function (result) {
            ...
            $("#create_materialType").append(soltStr);
            $("#create_materialType").chosen();

        });

        $("#create_startTime").daterangepicker({
        ...
        $("#save").on("click",function () {
            ...
            $.ajax({
                ...
                data:$("#createAdMaterialform").serialize(),
                type:"post",
