...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <div class="nav-search">
        <button type="button" class="btn btn-danger btn-sm" id="backBtn-1">
...
<div class="row" style="margin-left: 24px;">
    <div class="col-xs-11" id="content-detail">
        <form class="form-horizontal" role="form" id="detailProgramForm">
            <fieldset>
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="tabbable">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a data-toggle="tab" href="#movie-list" aria-expanded="true"><fmt:message key="zte.content.movieList"/> </a>
                                </li>
                            </ul>

                            <div class="tab-content">
                                <div id="movie-list" class="tab-pane fade active in" style="height: 400px;">
                    ...
                    <div class="col-xs-6">
                        <div style="margin-left: 30px;margin-top: 16px;"><small>视频预览</small></div>
...
<script>
    ...
    jQuery(function($) {
        ...
        var grid_selector_3 = "#grid-table-3";

        var parent_column_3 = $(grid_selector_3).closest('[class*="col-"]');

        //resize to fit page size
        $(window).on('resize.jqGrid', function () {
            $(grid_selector_3).jqGrid( 'setGridWidth', parent_column_3.width()-28);
        })
        ...
        $.get('<c:url value="/json/zteMovie_programDetail.do"/>', {"code": $("#programCode").val()}, function (data) {
            $("#detailProgramForm input").each(function(){
            ...
            jQuery(grid_selector_3).jqGrid({
                ...
                ondblClickRow : function (rowid, iRow, iCol, e) {
                    var src = $(grid_selector_3).getRowData(rowid).fileURL;
                    if (window.vlc) {
